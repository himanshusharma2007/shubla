...
const PaymentForm = () => {
  ...
  const getServiceIcon = () => {
    switch (booking.serviceType) {
      ...
      case "camp":
        return <Tent className="w-6 h-6 text-amber-700" />;
      case "parking":
        return <Car className="w-6 h-6 text-amber-700" />;
      default:
        return null;
    }
  };
        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 border border-amber-200">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-amber-900">
              {(booking.serviceType) && booking?.serviceType?.charAt(0)?.toUpperCase() +
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CardNumberElement className="w-full px-3 py-2 border border-amber-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white" />
                </div>
